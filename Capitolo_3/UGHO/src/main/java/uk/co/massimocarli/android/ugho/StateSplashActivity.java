...
/**
 * This version of the Splash take care of the rotation issues. Here we implemented the way
 * to retain the state.
 *
 * <p/>
...
public class StateSplashActivity extends Activity {
     ...
     */
    private static final String IS_DONE_KEY = "uk.co.massimocarli.android.ugho.key.IS_DONE_KEY";

    /**
     * THe key to use to save the mStartTime state variable
     */
    private static final String START_TIME_KEY = "uk.co.massimocarli.android.ugho.key.START_TIME_KEY";
