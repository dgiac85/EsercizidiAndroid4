...
/**
 * This version of the Splash takes care of the possible memory leak of the Handler. The
 * solution is to use a static class with a WeakReference to the Activity itself.
 * <p/>
